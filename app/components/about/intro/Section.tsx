...
export default function SectionIntroAboutComponent() {
    ...
    return (
        <SectionComponent
            ...
            {
                aboutContext["h2Intros"].map((h2Intro) =>
                    <H2Component
                        id={aboutContext["h2Intros"][aboutContext["h2Intros"].indexOf(h2Intro)]["id"]}
                        className={aboutContext["h2Intros"][aboutContext["h2Intros"].indexOf(h2Intro)]["className"]}
                        style={aboutContext["h2Intros"][aboutContext["h2Intros"].indexOf(h2Intro)]["style"]}>
                        {h2Intro["content"]}
                    </H2Component>
                )
            }
